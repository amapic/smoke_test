...
function DebugAlphaMaterial() {
  var a = 1;
  return a;
}

function DebugMergedMaterial() {
  var a = 1;
  return a;
}

function DebugVec3Material() {
  var a = 1;
  return a;
}

function RenderVolumeMaterial() {
  var a = 1;
  return a;
}
...
function startUp() {
  (highPerformance = !isPlatformMobile() && !QueryString.lowPerformance),
    ...
    assetLibrary.queueAsset(
      "skybox",
      "textures/skybox/specular/",
      AssetLibrary.Type.TEXTURE_CUBE
    ),
    assetLibrary.queueAsset(
      "irradiance",
      "textures/skybox/irradiance/",
      AssetLibrary.Type.TEXTURE_CUBE
    ),
...
function FluidSim(e, t, n, i, r) {
  ...
  (this._velocityBuffer = this._createDoubleBuffer()),
    ...
    (this._edgeMask = new THREE.DataTexture(
      this._createEdgeMaskData(),
      this._textureWidth,
      this._textureHeight,
      THREE.RGBAFormat,
    ...
    this._mode === FluidSim.Mode.SMOKE
      ? ((this._addDensity = new AddDensity(this)),
        (this._calculateCurl = new CalculateCurl(this)),
        (this._confineVorticity = new ConfineVorticity(this)),
        (this._applyForces.buoyancy = 0.05),
        (this._applyForces.gravity = 0))
      : ((this._addWater = new AddWater(this)),
...
function SmokeSimContent(e, t) {
  (this._highPerformance = e), (this._disco = t);
}
    ...
    u = THREE.UniformsUtils.merge([
      {
        ...
        absorption: {
          value: new THREE.Color(0.01, 0.01, 0.01)
        },
        numCells: {
        ...
        if (((t = this.passes[n]), t.enabled !== !1)) {
          ...
          void 0 !== THREE.MaskPass &&
            (t instanceof THREE.MaskPass
              ? (i = !0)
              : t instanceof THREE.ClearMaskPass && (i = !1));
        }
    },
    reset: function (e) {
      if (void 0 === e) {
...
(THREEx.RendererStats = function () {
  ...
  return {
    ...
    update: function (e) {
      if (
        (console.assert(e instanceof THREE.WebGLRenderer),
        !(Date.now() - s < 1e3 / 30))
      ) {
        s = Date.now();
        var t = 0;
  ...
  (AsyncTaskQueue.prototype = {
    ...
    execute: function () {
      ...
      (this._isRunning = !0), (this._currentIndex = 0), this._executeTask();
    },
    ...
    _executeImpl: function () {
      if (
        ...
        e.onComplete.bind(this._executeImpl, this), e.execute();
      } else if (this._queue.length === this._currentIndex)
        this.onComplete.dispatch();
      else {
        var t = this._queue[this._currentIndex];
        t.func.apply(this, t.args), ++this._currentIndex, this._executeTask();
      }
    }
  }),
  (Axes = function () {
    THREE.Object3D.call(this), this._init();
  }),
  (Axes.prototype = Object.create(THREE.Object3D.prototype)),
  (Axes.prototype._init = function () {
    var e = new THREE.CylinderBufferGeometry(0.01, 0.01, 1);
    e.translate(0, 0.5, 0);
  ...
  (CalculateNormals = {
    doAll: function (e) {
      for (var t = 0; t < e.children.length; ++t) {
        var n = e.children[t];
        n.geometry &&
          (n.geometry.computeVertexNormals(!1),
...
var CopyDataToRenderTarget = {
  execute: function (e, t, n) {
    ...
    (s.uniforms.tDiffuse.value = o), i.execute(s, t);
  }
};
...
var QueryString = (function () {
    for (
      ...
      var r = n[i].split("=");
      if ("undefined" == typeof e[r[0]]) e[r[0]] = decodeURIComponent(r[1]);
...
(RectRenderer.prototype = {
  ...
  (SwapMaterials = {
    setAll: function (e, t) {
      for (var n = 0; n < e.children.length; ++n) {
        var i = e.children[n];
        (i.material = t), SwapMaterials.setAll(i, t);
      }
    },
  ...
  (ShaderLibrary = {
    get: function (e) {
      return (
        ShaderLibrary["include_fluid.glsl"] +
      ...
      if (0 !== e) {
        for (var t = 0; t < e; ++t) {
          var n = this._updateQueue[t],
            i = n.entity;
          if (n.updatable) this._updateableEntities.push(i);
          else {
  ...
  (Entity = {
    ...
    convert: function (e) {
      Entity.isEntity(e) ||
        (EntityPrototype._init(e), Entity.ENGINE.registerEntity(e));
    },
    destroy: function (e) {
      Entity.ENGINE.destroyEntity(e);
    },
    addComponents: function (e, t) {
      for (var n = 0; n < t.length; ++n) Entity.addComponent(e, t[n]);
    },
    removeComponents: function (e, t) {
      for (var n = 0; n < t.length; ++n) Entity.removeComponent(e, t[n]);
    },
    addComponent: function (e, t) {
      if (t._entity) throw new Error("Component already added to an entity!");
      Entity.convert(e),
    ...
    removeComponent: function (e, t) {
      ...
      t.onRemoved();
      for (
        var n = !1, i = e._components.length, r = 0, o = [], s = 0;
        s < i;
        ++s
      ) {
        var a = e._components[s];
        a !== t && ((o[r++] = a), (n = n || !!t.onUpdate));
      }
  ...
  (ShaderLibrary["add_density_fragment.glsl"] =
  ...
  (ShaderLibrary["add_water_fragment.glsl"] =
  ...
  (ShaderLibrary["advect_maccormack_fragment.glsl"] =
  ...
  (ShaderLibrary["advect_semi_lagrangian_fragment.glsl"] =
  ...
  (ShaderLibrary["apply_forces_fragment.glsl"] =
  ...
  (ShaderLibrary["apply_projection_fragment.glsl"] =
  ...
  (ShaderLibrary["calculate_curl_fragment.glsl"] =
  ...
  (ShaderLibrary["calculate_divergence_fragment.glsl"] =
  ...
  (ShaderLibrary["confine_vorticity_fragment.glsl"] =
  ...
  (ShaderLibrary["debug_merged_fragment.glsl"] =
  ...
  (ShaderLibrary["debug_merged_vertex.glsl"] =
    "varying vec2 texCoords;\n\nvoid main() {\n    vec3 localPos = position;\n    vec4 viewPos = modelViewMatrix * vec4(localPos, 1.0);\n    gl_Position = projectionMatrix * viewPos;\n    texCoords = uv;\n}"),
  (ShaderLibrary["div_press_borders_fragment.glsl"] =
  ...
  (ShaderLibrary["volumetric_lighting_fragment.glsl"] =
  ...
  (ShaderLibrary["volumetric_lighting_vertex.glsl"] =
    "varying vec2 texCoords;\n\nvoid main() {\n    gl_Position = vec4(position, 1.0);\n    texCoords = uv;\n}\n"),
  (ShaderLibrary["debug_alpha_fragment.glsl"] =
    "varying vec2 texCoords;\nuniform sampler2D map;\n\nvoid main() {\n    vec4 samp = texture2D(map, texCoords);\n    gl_FragColor = vec4(samp.www, 1.0);\n}\n"),
  (ShaderLibrary["debug_alpha_vertex.glsl"] =
    "varying vec2 texCoords;\n\nvoid main() {\n    vec3 localPos = position;\n    vec4 viewPos = modelViewMatrix * vec4(localPos, 1.0);\n    gl_Position = projectionMatrix * viewPos;\n    texCoords = uv;\n}"),
  (ShaderLibrary["debug_vec3_fragment.glsl"] =
    "varying vec2 texCoords;\nuniform sampler2D map;\n\nvoid main() {\n    vec4 samp = texture2D(map, texCoords);\n    gl_FragColor = vec4(samp.xyz * .5 + .5, 1.0);\n}\n"),
  (ShaderLibrary["debug_vec3_vertex.glsl"] =
    "varying vec2 texCoords;\n\nvoid main() {\n    vec3 localPos = position;\n    vec4 viewPos = modelViewMatrix * vec4(localPos, 1.0);\n    gl_Position = projectionMatrix * viewPos;\n    texCoords = uv;\n}"),
  (ShaderLibrary["render_volume_fragment.glsl"] =
  ...
  (ShaderLibrary["render_volume_vertex.glsl"] =
...
(window.onload = startUp),
  ...
  (AssetLibrary.prototype = {
    ...
    _model: function (e, t, n) {
      ...
      (r.options = r.options || {}),
        ...
        r.load(e, function (e) {
          (i._assets[t] = e), i._onAssetLoaded();
        });
    },
  ...
  (BillboardComponent.prototype.onUpdate = function (e) {
    this._v.setFromMatrixPosition(this._camera.matrixWorld),
      ...
      this._constantSize &&
        (this._v.copy(this.entity.position),
  ...
  (MoveAroundComponent.prototype.onUpdate = function (e) {
    ...
    (t.x =
      Math.sin(this._time * this._speed.x + this._phaseOffset.x) *
      this._radius),
      (t.y =
        Math.sin(this._time * this._speed.y + this._phaseOffset.y) *
        this._radius),
      (t.z =
        Math.sin(this._time * this._speed.z + this._phaseOffset.z) *
        this._radius);
  }),
  (OrbitController = function (e, t, n) {
    Component.call(this),
      (this._container = e),
      (this._coords = new THREE.Vector3(0.5 * Math.PI, 0.5 * Math.PI, 2)),
  ...
  (OrbitController.prototype.onUpdate = function (e) {
    (this._localVelocity.x *= this.dampen),
      ...
      (this._coords.y = THREE.Math.clamp(
        this._coords.y,
        this.minPolar,
        this.maxPolar
      )),
      (this._coords.z = THREE.Math.clamp(
        this._coords.z,
        this.minRadius,
        this.maxRadius
      )),
      void 0 !== this.maxAzimuth &&
        ...
        (this._coords.x = THREE.Math.clamp(
          this._coords.x,
          this.minAzimuth,
          this.maxAzimuth
        ));
    var t = this.entity,
      n = this._m,
      i = this._fromSphericalCoordinates(
        this._coords.z,
        this._coords.x,
        this._coords.y
      );
  ...
  (OrbitController.prototype._updateMove = function (e, t) {
    if (void 0 !== this._oldMouseX) {
      var n = e - this._oldMouseX,
        i = t - this._oldMouseY;
      this.setAzimuthImpulse(0.0015 * n), this.setPolarImpulse(0.0015 * -i);
    }
    ...
    (this._onMouseWheel = function (t) {
      ...
      (this._onMouseDown = function (t) {
        (e.shiftKey && !t.shiftKey) ||
          ((e._oldMouseX = void 0), (e._oldMouseY = void 0), (e._isDown = !0));
      }),
  ...
  (AdvectSemiLagrangian.prototype = Object.create(
  ...
  (CalculateDivergence.prototype = Object.create(
    THREE.ShaderMaterial.prototype,
    {
      velocity: {
        get: function () {
  ...
  (FluidSim.prototype = {
    ...
    addWater: function (e, t) {
      console.assert(
        this._mode === FluidSim.Mode.WATER,
        "Mode is set to SMOKE. Use addDensity instead."
      ),
        (this._addWater.source = this._dataBuffer.source);
      var n = this._addWater.sourcePosition;
      n.copy(e),
        (n.x += 0.5 * this._numCellsX),
        (n.y += 0.5 * this._numCellsY),
        (n.z += 0.5 * this._numCellsZ),
    ...
    addDensity: function (e, t) {
      console.assert(
        this._mode === FluidSim.Mode.SMOKE,
        "Mode is set to WATER. Use addWater instead."
      ),
    ...
    setExternalForce: function (e, t, n) {
      ...
      i.copy(e),
        (i.x += 0.5 * this._numCellsX),
        (i.y += 0.5 * this._numCellsY),
        (i.z += 0.5 * this._numCellsZ),
    ...
    _createEdgeMaskData: function () {
      return this._floatTextureType === THREE.FloatType
        ? this._createEdgeMaskData32()
        : this._createEdgeMaskData16();
    },
    ...
    _createInitialFieldData: function () {
      return this._floatTextureType === THREE.FloatType
        ? this._createInitialFieldData32()
        : this._createInitialFieldData16();
    },
    ...
    reset: function () {
      ...
      CopyDataToRenderTarget.execute(
        e,
        this._velocityBuffer.target,
        this._renderer
      ),
        this._velocityBuffer.swap(),
        CopyDataToRenderTarget.execute(
          e,
          this._dataBuffer.target,
          this._renderer
        ),
        this._dataBuffer.swap();
    },
    ...
    _executeConfineVorticity: function () {
      (this._calculateCurl.velocity = this._velocityBuffer.source),
        ...
        this._rectRenderer.execute(
          this._confineVorticity,
          this._velocityBuffer.target
        ),
        this._velocityBuffer.swap(),
        this._applyVelocityBorders();
    ...
    _executeAdvectMacCormack: function (e, t) {
      (this._advectSemiLagrangian.velocity = this._velocityBuffer.source),
        ...
        (this._advectSemiLagrangian.dt = e),
        this._rectRenderer.execute(
          this._advectSemiLagrangian,
          this._auxBuffer.target
        ),
        this._auxBuffer.swap(),
        (this._advectSemiLagrangian.velocity = this._velocityBuffer.source),
    ...
    _createDoubleBuffer: function () {
      return new DoubleBufferTexture(
        this._textureWidth,
        this._textureHeight,
        this._getRTOptions()
      );
  ...
  (DebugAlphaMaterial.prototype = Object.create(
    THREE.ShaderMaterial.prototype
  )),
  ...
  (DebugMergedMaterial.prototype = Object.create(
    THREE.ShaderMaterial.prototype
  )),
  ...
  (RenderVolumeMaterial.prototype = Object.create(
    THREE.ShaderMaterial.prototype,
    {
      absorption: {
        get: function () {
  ...
  (RenderVolumeMaterial.prototype.update = function (e, t, n) {
    ...
    i.multiplyMatrices(t.matrixWorldInverse, e.matrixWorld), i.getInverse(i);
  }),
  ...
  (SkyMaterial.prototype = Object.create(THREE.ShaderMaterial.prototype, {
    color: {
      ...
      set: function (e) {
        (this._color = e), (this.uniforms.color.value = e);
      }
    },
    envMap: {
      get: function () {
    ...
    init: function (e, t, n) {
      (this._options = n || {}),
        ...
        (this._options.preserveDrawingBuffer =
          this._options.preserveDrawingBuffer || !1),
        (this.assetLibrary = t),
        this._initRenderer(),
        (this._debugMode = e),
        e && this._initStats();
      ...
      if (this._isRunning) {
        ...
        null !== this._time && (t = e - this._time),
          ...
          this._content && this._content.effectComposer
            ? this._content.effectComposer.render(t / 1e3)
  ...
  (SmokeSimContent.prototype = {
    init: function (e) {
      ...
      (this._forceStrength = 60),
        ...
        (this._fluidAbsorption = new THREE.Color(0.02, 0.015, 0.01)),
        this._fluidAbsorption.multiplyScalar(this._highPerformance ? 0.2 : 0.4),
        (this._scene = e.scene),
        ...
        (this._hasMousePos = !1),
        (this._lightingRenderer = new VolumetricLightRenderer(
          this._renderer,
          this._fluidSim.numCellsX,
          this._fluidSim.numCellsY,
          this._fluidSim.numCellsZ,
          this._numLightSamples
        )),
        (this._lightingRenderer.absorption = this._fluidAbsorption),
        this._lightingRenderer.absorption.multiplyScalar(4),
        (this._lightingRenderer.irradiance = this._assetLibrary.get(
          "irradiance"
        )),
    ...
    update: function (e) {
      this._hasMousePos &&
        (this._fluidSim.setExternalForce(
          this._mouseCell,
          this._mouseMovement,
          e * this._forceStrength
        ),
        this._mouseDown && this._fluidSim.addDensity(this._mouseCell, 0.2 * e)),
        this._fluidSim.update(e),
        this._lightingRenderer.render(
          this._fluidSim.dataBuffer.source,
          this._fluidSim.auxBuffer.target,
          this._fluidMesh,
          this._camera
        ),
        this._fluidSim.auxBuffer.swap(),
        this._renderSmokeMaterial.update(
          this._fluidMesh,
          this._camera,
          this._fluidSim.auxBuffer.source
        );
    },
    _initCameraController: function () {
      var e = new OrbitController(
    ...
    _initScene: function () {
      ...
      (this._renderSmokeMaterial = new RenderVolumeMaterial(
        this._fluidSim,
        e,
        this._numDensitySamples
      )),
        (this._renderSmokeMaterial.transparency = 0.005),
        (this._renderSmokeMaterial.absorption = this._fluidAbsorption);
      var t = new THREE.BoxBufferGeometry(
        this._fluidSim.numCellsX,
        this._fluidSim.numCellsY,
        this._fluidSim.numCellsZ
      );
      if (
        ((this._fluidMesh = new THREE.Mesh(t, this._renderSmokeMaterial)),
        this._scene.add(this._fluidMesh),
        this._disco)
      )
        this._addPointLight(0.001, 0.0015, 8e-4, 0, 0.5, 1.4, 16711680),
          this._addPointLight(8e-4, 0.001, 95e-5, 0.2, 0.9, 0.88, 65280),
          this._addPointLight(0.0015, 85e-5, 0.001, 0.7, 0.3, 0.5, 255);
      else {
  ...
  (WaterSimContent.prototype = {
    init: function (e) {
      ...
      (this._forceStrength = 200),
        (this._numLightSamples = t / 4),
        (this._numDensitySamples = t),
        (this._fluidAbsorption = new THREE.Color(0.1, 0.05, 0.03)),
    ...
    update: function (e) {
      this._hasMousePos &&
        ...
        this._fluidSim.auxBuffer.swap(),
        this._renderWaterMaterial.update(
          this._fluidMesh,
          this._camera,
          this._fluidSim.auxBuffer.source
        );
    ...
    _initScene: function () {
      ...
      (this._renderWaterMaterial = new RenderVolumeMaterial(
        this._fluidSim,
        e,
        this._numDensitySamples
      )),
      ...
      if (
        ((this._fluidMesh = new THREE.Mesh(t, this._renderWaterMaterial)),
        this._scene.add(this._fluidMesh),
        this._disco)
      )
        this._addPointLight(0.001, 0.0015, 8e-4, 0, 0.5, 1.4, 16711680),
        ...
        i.position.set(1, 1, 1), this._lightingRenderer.addLight(i);
      }
    },
    _addPointLight: function (e, t, n, i, r, o, s) {
      var a = new THREE.PointLight(s);
  ...
  (VolumetricLighting.prototype = Object.create(
    THREE.ShaderMaterial.prototype,
    {
      densityField: {
        get: function () {
